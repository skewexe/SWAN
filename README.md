...
Ensure you have Node.js 24, pnpm, and Docker installed.
Clone the repository: git clone https://github.com/skewexe/SWAN.git
Run the automated setup script: chmod +x install.sh && ./install.sh
